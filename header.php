...
<body class="mdui-appbar-with-toolbar mdui-theme-primary-indigo mdui-theme-accent-pink">
  ...
  <div class="mdui-drawer mdui-drawer-close" id="drawer">
    <div class="mdui-list" mdui-collapse="{accordion: true}">
        ...
        <img src="https://s1.ax1x.com/2017/11/04/0alWD.png">
        <div class="mdui-grid-tile-actions">
		  <div class="mdui-grid-tile-text">
			<div class="mdui-grid-tile-title">Alcatraz</div>
			<?php if ($this->options->description): ?>
			<div class="mdui-typo-caption"><?php $this->options->description(); ?></div>
			<?php endif; ?>
		  </div>
        </div>
	  
      </div>
      <li class="mdui-subheader">路标</li>
      <a href="<?php $this->options->siteUrl(); ?>" class="mdui-list-item mdui-ripple mdui-typo-title">主页</a>
      
<a href="http://alcatrazdev.ml" class="mdui-list-item mdui-ripple mdui-typo-title">
		  
		  <div class="mdui-list-item-content">
			<div class="mdui-list-item-text">alcatrazdev.ml</div>
		  </div>
        </a>
    ...
    <div class="drawer-info drawer-item">
      ...
      <div class="header-copyright">
        <p class="site-info">Theme created by <a class="site-info" href="https://www.eaimty.com/" target="_blank">EAimTY</a></p>
<p class="site-info">Modified by Alcatraz</p>
<p class="site-info mdui-text-center"></br>Copyright©2017 AlcatrazDev</p>
